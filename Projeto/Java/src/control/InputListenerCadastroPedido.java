	...
	public void capturarDadosPedido() {
		...
		if (!(cadastroPedido.getTextPreco().getText().equals("") 
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Valor Inválido! (Valor total do pedido)", null,
							JOptionPane.ERROR_MESSAGE);
					return;
				}

				//getPedido().setIdCliente();
				//getPedido().setIdFuncionario(cadastroPedido.getTextNome().getText());
