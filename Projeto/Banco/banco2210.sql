...
insert  into `compra`(`idCompra`,`nomeFornecCompra`,`cnpjFornecCompra`,`dataCompra`,`outrosCompra`,`valorTotalCompra`,`chaveAcessoCompra`,`dataEntradaCompra`,`numeroNFECompra`,`idFuncCompra`) values (4,'23124','1','null',10,8,'1','2017-10-22',0,1),(5,'1','1','null',1,10,'','2017-10-22',1,1),(6,'1','1','null',1,10,'','2017-10-22',10,1),(7,'12312','213','null',213,225,'','2017-10-22',123,1),(8,'1','1','11/22/1111',1,15,'','2017-10-22',121,1);
...
CREATE TABLE `compra_has_produto` (
  ...
  `precoCompra` float unsigned NOT NULL DEFAULT '0',
...
insert  into `pedido_has_produto`(`Pedido_idPedido`,`Produto_idProduto`,`qtdVenda`,`qtdControle`,`precoUnitItem`,`precoTotalItem`) values (13,1,2,0,10,20),(13,2,1,0,20,20),(14,1,5,0,10,50),(14,2,2,0,20,40),(17,1,2,2,10,20);
